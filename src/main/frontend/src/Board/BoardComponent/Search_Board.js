...
function Search_Board({category, type, keyword}) {
    ...
    const _handlePage = (e, page) => {
        ...
        setTimeout(() => {
            AxiosURL.getSearchList(category, type, keyword, page).then(res => {
    ...
    useEffect(() => {
        AxiosURL.getSearchList(category, type, keyword, pageList[0])
            .then(res => {
            ...
            <table id="main_board">
                ...
                {dtoList.length ?
                    ...
                    <tr id="board_body">
                        ...
                        <td className="listNoData">검색 결과가 없습니다</td>
                    </tr>
                }
                </tbody>
            </table>
